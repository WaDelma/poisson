...
#[test]
fn test_2d_max_radius_perioditic() {
    let radius = 0.499999999;
    test_with_seeds::<Vec2>(radius, 400, true);
}

#[test]
fn test_2d_2nd_max_radius_perioditic() {
    let radius = 2f64.sqrt() / 2f64 / 2f64;
    test_with_seeds::<Vec2>(radius, 200, true);
}

#[test]
fn test_2d_4th_of_max_radius_perioditic() {
    let radius = 2f64.sqrt() / 2f64 / 4f64;
    test_with_seeds::<Vec2>(radius, 100, true);
}

#[test]
fn test_2d_8th_of_max_radius_perioditic() {
    let radius = 2f64.sqrt() / 2f64 / 8f64;
    test_with_seeds::<Vec2>(radius, 50, true);
}

#[test]
fn test_2d_16th_of_max_radius_perioditic() {
    let radius = 2f64.sqrt() / 2f64 / 16f64;
...
#[test]
fn test_2d_2th_of_max_radius_prefilled_with_max_radius_perioditic() {
    let radius = 2f64.sqrt() / 2f64;
...
#[test]
fn test_2d_4th_of_max_radius_prefilled_with_2rd_of_max_radius_perioditic() {
    let radius = 2f64.sqrt() / 2f64;
...
#[test]
fn test_2d_8th_of_max_radius_prefilled_with_4th_of_max_radius_perioditic() {
    let radius = 2f64.sqrt() / 2f64;
...
#[test]
fn test_2d_16th_of_max_radius_prefilled_with_8th_of_max_radius_perioditic() {
    let radius = 2f64.sqrt() / 2f64;
