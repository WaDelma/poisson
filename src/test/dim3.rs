...
fn test_3d_100_80_normal() {
    test_with_samples::<Vec3>(100, 0.8, 400, false);
}

#[test]
fn test_3d_100_80_perioditic() {
    test_with_samples::<Vec3>(100, 0.8, 200, true);
}
...
fn test_3d_2th_prefilled_1th_normal() {
    ...
    test_with_seeds_prefill::<Vec3, _>(radius / 2f64,
                                       800,
                                       false,
                                       &mut |ref mut v, i| {
...
fn test_3d_8th_prefilled_4th_normal() {
    let radius = 2f64.sqrt() / 2f64;
    test_with_seeds_prefill::<Vec3, _>(radius / 8f64,
                                       100,
                                       false,
                                       &mut |ref mut v, i| {
                                           let rand = XorShiftRng::from_seed([i * 2 + 1,
